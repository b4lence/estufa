...
<head>
    ...
    <link rel="stylesheet" href="_css/configuracoes.css">
...
<body>
        ...
        <div class="menu-content">
            ...
            <nav class="nav-bar">
                ...
                <ul class="link-nav" id="selecionado">
                    <svg class="icon" id="selecionado" xmlns="http://www.w3.org/2000/svg" data-name="Livello 1"
                        id="Livello_1" viewBox="0 0 128 128">
                        <title />
                        <path
                    ...
                    <li class="icon-text" id="selecionado"><a href="configuracoes.php
                    "
                            id="selecionado">Configurações</a></li>
                    <div class="seta"></div>
                </ul>
        ...
        <div class="main-content">
            ...
            <div class="perfilUsuario">
                ...
                <div class="cima">
                    ...
                    <img src="_assets/background.jpg" alt="background" class="img-background">
                </div>

                <form class="baixo" action="_php/_config/uploadImg.php" method="POST" enctype="multipart/form-data">
                    <input type="file" id="input-usuario" accept="image/*" style="display: none;" name="uploadImg"
                        onchange="this.form.submit();">
                    <label for="input-usuario">
                        <img src="_assets/_img-userconfig/default.png" alt="foto do usuário" class="img-usuario"
                            id="img-usuario">
                    </label>
                    <p id="username">Tom Hanks</p>
                    <p class="plantAtual">Planta atual:&nbsp;<span id="planta-atual"></span></p>
                </form>
            ...
            <div class="configuracoes">
                ...
                <div class="trocarUsuario">
                    ...
                    <p class="tituloConfiguracoes">Trocar nome de usuário</p>

                    <form action="_php/_config/alterarNome.php" method="post" class="form-box">

                        <div class="input-box">
                            <input type="text" name="novoUsuario" class="input" required placeholder=" " />
                            <label class="label">Novo usuário</label>
                        </div>

                        <div class="input-box">
                            <input type="text" name="confirmeUsuario" class="input" required placeholder=" " />
                            <label class="label">Confirme o usuário</label>
                        </div>
                ...
                <div class="trocarSenha">
                    ...
                    <p class="tituloConfiguracoes">Trocar senha</p>

                    <form action="_php/_config/alterarSenha.php" method="post" class="form-box">

                        <div class="input-box">
                            <input type="password" name="velhaSenha" class="input" required placeholder=" " />
                            <label class="label">Senha atual</label>
                        </div>

                        <div class="input-box">
                            <input type="password" name="novaSenha" class="input" required placeholder=" " />
                            <label class="label">Nova senha</label>
                        </div>

                        <div class="input-box">
                            <input type="password" name="confirmarSenha" class="input" required placeholder=" " />
    ...
    <script type="module" src="_js/config.js"></script>
